...
const tokens: Record<GebDeployment, TokenList> = {
    ...
    'arbitrum-goerli': {
        ...
        FTRG: {
            ...
            collateralJoin: '0xB3a8efDBA29fb701006060f02eb95f9D1630CFBC',
            collateralAuctionHouse: '0xD62cA551a2020DfEa030eA3E811F641df86c5aBd',
            decimals: 18,
            symbol: 'FTRG',
            bytes32String: FTRG,
            isCollateral: true,
        ...
        WBTC: {
            address: '0x422d6eB01C86DAEcaa9BEd0b57Dc04294EeB2991',
            collateralJoin: '0x8FB2B20430961bF94124FFa7A749c856B185b4DD',
            collateralAuctionHouse: '0x6ea1C41521e5761e0Bb31D009c630470EcBe6b30',
            decimals: 8,
            symbol: 'WBTC',
            bytes32String: WBTC,
            isCollateral: true,
        ...
        STN: {
            address: '0xeAe382e8cC9B6687683d4Ad59de30730a9D53803',
            collateralJoin: '0x6fdb9C0eD5EC5A94fbd78af9E93b2A3f7c5cF076',
            collateralAuctionHouse: '0x230644DE87cbfF7244c444dce09E772bC4f470D2',
            decimals: 3,
            symbol: 'STN',
        ...
        TOTEM: {
            address: '0x9485de7A78097398Aec74C930c82A67eee5c496b',
            collateralJoin: '0x3f800B236dac660B1B3206dAa40e3A86a1a579B6',
            collateralAuctionHouse: '0x64B43945fD7D6486d3eB978BF5cf3f205B98D23D',
            decimals: 3,
            symbol: 'TOTEM',
            bytes32String: TOTEM,
            isCollateral: true,
